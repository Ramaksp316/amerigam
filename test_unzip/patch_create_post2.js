...
const filePath = path.join(__dirname, "CreatePostForm.tsx");
...
// We will replace the entire main component return statement
const returnIndex = content.lastIndexOf("  return (\n    <form");
if (returnIndex === -1) throw new Error("Could not find return statement");

// Add showTagInput state if missing
...
console.log("Rewritten scratch/CreatePostForm.tsx successfully!");
