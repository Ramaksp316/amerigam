        ...
        {step === 0 && (
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
            ...
            <label style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
              ...
              <input type="url" name="coverImage" className="input-modern" value={formData.coverImage} onChange={handleChange} placeholder="https://example.com/banner.jpg" />
...
fs.writeFileSync('app/create/CreateEventForm.tsx', wizardCode);
